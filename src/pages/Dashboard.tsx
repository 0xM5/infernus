              ...
              <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
                <div className="space-y-3 sm:space-y-4 w-full lg:w-auto">
                      ...
                      <TooltipProvider>
                        <Tooltip>
                          ...
                          <TooltipContent className="flex items-center gap-2">
                            <p>Private testing phase. Send bugs, questions and suggestions via Discord</p>
                            <button
                              onClick={() => {
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 items-stretch sm:items-center w-full flex-wrap">
                    ...
                    {/* Winners/Losers and Win/Loss Ratio Container */}
                    <div className="flex flex-col lg:flex-row gap-3 sm:gap-4 items-stretch flex-shrink-0">
                      {/* Winners/Losers Box */}
