  ...
  return (
    <div className="min-h-screen w-full bg-background flex items-center justify-center p-8">
      <div className="relative">
        ...
        {/* Logout and Beta Footer - inside main container at bottom */}
        {isExpanded && (
          <div className="absolute bottom-6 left-1/2 transform -translate-x-1/2 flex flex-col items-center gap-6 w-full max-w-[600px] px-8">
            <div className="flex items-center gap-2">
            ...
            <div className="bg-secondary/50 border border-border/50 rounded-lg px-3 py-2 text-center text-xs text-muted-foreground w-full">
              ...
              <button
                ...
                className="inline-flex items-center gap-1 text-primary hover:text-primary/80 transition-colors cursor-pointer ml-1"
              >
                <svg
