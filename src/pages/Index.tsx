...
const Index = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-background flex items-center justify-center p-8">
      ...
      {/* Beta Footer - outside calendar, under logout */}
      {isExpanded && (
        <div className="mt-3 flex justify-center">
          <div className="bg-secondary/50 border border-border/50 rounded-lg px-3 py-2 text-center text-xs text-muted-foreground max-w-[600px]">
