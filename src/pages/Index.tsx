    ...
    return <div className="min-h-screen w-full flex flex-col items-center justify-between bg-background text-foreground py-12 px-4">
        <div className="flex-1 flex flex-col items-center justify-center max-w-3xl w-full">
          <div className="text-center space-y-4">
            ...
            <p className="text-xl text-muted-foreground text-gray-400" style={{
            fontFamily: 'Inter, sans-serif'
          }}>
              Built for what traders{" "}
              <span className="relative inline-block">
                <span className="relative z-10">actually</span>
                <span className="absolute bottom-0 left-0 w-full h-0.5 bg-gradient-to-r from-primary to-[hsl(263_70%_50%)] via-[hsl(0_84%_60%)]" style={{
                background: 'linear-gradient(90deg, hsl(263 70% 50%), hsl(0 84% 60%))'
              }}></span>
              </span>{" "}
              need.
            </p>
        ...
        <footer className="text-sm text-muted-foreground text-gray-400 flex items-center gap-2 justify-center" style={{
        fontFamily: 'Inter, sans-serif'
      }}>
          ...
          <span className="text-primary select-all cursor-pointer">mfve</span>
        </footer>
      </div>;
  }
